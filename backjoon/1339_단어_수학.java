...
/*
* 브루트포스 문제 (문제 풀고보니 그리디 알고리즘 문제였습니다. 그리디 풀이는 단어수학-2 따로 풀어본 후 다시 올리도록 하겠습니다.)
*
* 해당 문제의 로직은 다음과 같습니다.
...
*
* 사실 문제를 보고 바로 브루트포스로 로직을 쉽게 떠올릴 수 있기 때문에 상세한 설명보다는 java에서 어떻게 속도를 개선했는가로 설명하겠습니다.
* 해당 문제를 브루트포스로 통과할 것이라고 생각했던 점이 바로 최대 10가지 조합이면 제한 시간인 2초안에는 출력이 가능하다고 판단됐기 때문입니다.
* 다만 이를 위해서 각각 1,2,3 과정에서 속도를 개선해주셔야합니다.
*
* 1. 입력된 알파벳을 정확히 기억함으로써 최대 10번의 조합만 가능하게 만들어줍니다. 즉 입력되지 않은 알파벳까지 조합을 통해 숫자를 넣어주지 말아야합니다.
...
*   나중에 문자 하나하나 조회 할 때 change['해당 문자'-'A'] 를 통하여 그 문자에 해당하는 숫자 값을 읽을 수 있습니다.
*
