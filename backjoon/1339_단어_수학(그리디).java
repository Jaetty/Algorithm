...
* F = 1
* G = 100
* 이렇게 됩니다. 그러면 이것을 값이 큰 순서로하면 정렬해주면 A, C, D, G, E, F, B 와 같이 될 것입니다.
* 그러면 A의 값인 10000부터 1의 값인 B까지 9,8,7...3를 순서대로 곱해주고 모든 값들을 더해주면 가장 큰 값을 구할 수 있습니다.
*
* 위의 로직을 코드로 구현하면 문제를 해결할 수 있습니다.
*
*
* */