...
* 3. 2번의 과정 중 더 이상 나누어 떨어질 수 없다면 노드들 리턴합니다.
* 4. 리턴 받은 노드들을 각각 부모의 좌 우에 붙여줍니다.
* 5. 이 과정을 맨 최초의 루트 노드에 도달할 때 까지 반복합니다.
*
* 즉 위의 입력 예시로 생각해보면 좌 우의 경계가 3 4 2 / 6 5 / 1이니까
* 3 4 2에 따라 2번 풀이를 적용하면 다시 3 / 4 / 2가 되고
* 각자 더이상 나뉠 수 없기 때문에 2의 좌 우에 3, 4가 붙습니다.
*               1
*
*       2           5
*      / \
*     3   4             6
* 그리고 5와 6을 기준으로 생각해보면  ( 좌에 노드 없음 ) / 5 / 6 이므로
* 6의 오른쪽에 5를 붙여줍니다.
*               1
*
*       2           5
...
*               3   4     6
*
* 이렇게 분할 정복이 진행되고 이를 코드로 구현하게 되면 문제를 해결할 수 있습니다.
*
* */