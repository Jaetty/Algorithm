...
// binary counting <= 본질적으로 부분 집합 문제를 푸는 방식
// 부분 집합 원소 하나를 선택 / 비선택, boolean select[]
...
public class BJ_도영이가만든맛있는음식_2961_3 {
	...
	public static void main(String[] args) throws Exception{
		...
		// 모든 부분집합의 경우의 수
		// 4 개 => 2 x 2 x 2 x 2 = 16
		// 1 << 4
		// 0000_0001 => 0  0  0  1  0  0  0  0
		//					    16  8  4  2  1
		...
		for(int i=1; i<count; i++) { // 모든 부분집합에 대해서 // i는 1부터 왜냐면 재료는 한가지 이상 선택해야해서
